...
<head>
        ...
        <!-- style css -->
        <link rel="stylesheet" type="text/css" href="resources/css/style.css"> <!-- This stylesheet dynamically changed from style.less -->
        <!-- responsive css -->
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-3">
                                    <div class="logo-part">
                                        <a href="index.html">
                                            <img class="normal-logo" src="{{asset('ffrontend/images/logo-light.png') }}" alt="logo">
                                            <img class="sticky-logo" src="{{asset('ffrontend/images/logo-dark.png') }}" alt="logo">
                                        </a>
                                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 md-mb-30">
                            <div class="rs-animation-shape">
                                <div class="images">
                                   <img src="assets/frontend/images/about/about-3.png" alt="">
                                </div>
                                <div class="middle-image2">
                                   <img class="dance" src="{{ asset('frontend/images/about/effect-1.png') }}" alt="">
                                </div>
                            </div>
                        </div>
