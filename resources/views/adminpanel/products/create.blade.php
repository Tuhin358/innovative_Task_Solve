                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="product_name" id="product_name"
                                      placeholder="product_name" value=" ">
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text"
                                        class="form-control" name="price" id="price" placeholder="price" value=" ">
                                        {{--  {{ old('title') }}  --}}
                                </div>
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="details" id="details" class="form-control"
                                         placeholder="Enter Project details"  value=" "></textarea>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="thumbnail_image">thumbnail_image<span class="text-danger">*</span></label>
                                    <input type="file" name="thumbnail_image" class="form-control" id="thumbnail_image" placeholder="thumbnail_image...." />
